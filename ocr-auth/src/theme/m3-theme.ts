...
export const m3Theme = createTheme({
  ...
  shadows: [
    ...
    'var(--md-sys-elevation-level6)',
    'var(--md-sys-elevation-level7)',
    'var(--md-sys-elevation-level8)',
    'var(--md-sys-elevation-level9)',
    'var(--md-sys-elevation-level10)',
    'var(--md-sys-elevation-level10)', // Level 11+
    'var(--md-sys-elevation-level10)',
    'var(--md-sys-elevation-level10)',
    'var(--md-sys-elevation-level10)',
    'var(--md-sys-elevation-level10)',
