...
"""
Sync page_images from local storage to PostgreSQL database.
"""
...
from scripts.database import DatabaseSession, Document
    ...
    for doc_file in doc_files:
        try:
            ...
            with DatabaseSession() as db:
                ...
                # Update page_images in database
                doc.page_images = json.dumps(page_images)
